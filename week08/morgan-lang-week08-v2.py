...
try:
    ...
    Productizer.ReadAllFileData(objFile, "Here is the current data:")
    Productizer.WriteProductUserInput(objFile)
    Productizer.ReadAllFileData(objFile, "Here is this data was saved:")
except FileNotFoundError as e:
    print("Error: " + str(e) + "\n Please check the file name")
except Exception as e:
    print("Error: " + str(e))
finally:
    if (Productizer.objFile != None): Productizer.objFile.close()
